...
8.1.2 实例25：用JDBCTemplate实现数据的增加、删除、修改和查询 157
8.1.3 认识ORM 161
...
13.3 实例56：在Spring Boot中实现增加、删除、修改、查询 文档的功能 353
...
14.2.1 实现管理（增加、删除、修改和查询）管理员角色功能 380
14.2.2 实现管理权限功能 381
